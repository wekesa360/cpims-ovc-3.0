...
class OVCHIVManagement(models.Model):
    ...
    substitution_firstline_date = models.DateTimeField(default=datetime..now())
...
#     ##rec_organization=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, related_name="receiving_organization", default=0)
#     # transfering_org=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, default=0)
...
#     # form = models.ForeignKey(OVCCareForms, on_delete=models.CASCADE)
#     is_void = models.BooleanField(default=False)
#     event = models.ForeignKey(OVCCareEvents, on_delete=models.CASCADE, default="b7ea884e-c933-11ec-89a4-e1fe85340968")
#     timestamp_created = models.DateTimeField(default=timezone.now)
#     timestamp_updated = models.DateTimeField(auto_now=True)
