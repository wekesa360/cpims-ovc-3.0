...
# transferChoices =  [('', 'Please Select')] + list(CHOICES)
class CaseTransferForm(forms.Form):
    CHOICES = [('', 'Please Select')] + list(
        ('Child ages out of the program prior to achieving their case plan',
        'Child and or family plans to relocate prior to achieving their case plan',        ('Program relocates or closes before recommended interventions have been completed',
