...
CHOICES = ['Child ages out of the program prior to achieving their case plan','Child and or family plans to relocate prior to achieving their case plan' ]
transferChoices =  [('', 'Please Select')] + CHOICES
...
class CaseTransferForm(forms.Form):
    ...
    REASON = forms.ChoiceField(
        choices=transferChoices, widget=forms.Select(
            attrs={
                'id': 'transfer_reason',
                'class': 'form-control',
                'data-parsley-required': "false",
