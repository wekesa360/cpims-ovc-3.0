...
class OVCCareTransfer(models.Model):
    ...
    rec_organization=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, related_name="receiving organization")
    transferring_org=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, related_name="transfering organization")
