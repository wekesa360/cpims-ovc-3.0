...
def case_transfer(request, id):
    try:
        ...
        currentOrganization = OVCRegistration.objects.get(is_void=False, child_cbo_id.id=id)
        pdb.set_trace()
        ...
        if request.method == 'POST':
            ...
            for hhmember in hhmembers:
                ...
                OVCCareTransfer(
                    ...
                    # child_cbo_id=OVCRegistration.objects.get(child_cbo_id.id=organization_id)
                ).save()
