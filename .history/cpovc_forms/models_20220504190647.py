...
class OVCCareTransfer(models.Model):
    ...
    organization=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, related_name='current_orgranization', default="b7ea884e-c933-11ec-89a4-e1fe85340968")
    # case_manager= models.ForeignKey(RegPerson, on_delete=models.CASCADE)
    rec_organization=models.ForeignKey(RegOrgUnit, on_delete=models.CASCADE, related_name='receiving_organization')
