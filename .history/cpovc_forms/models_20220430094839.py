...
class OVCGokBursary(models.Model):
    ...
    father_chroclass OVCCareTransfer(models.Model):
	...
	organization=models.ForeignKey(reg_org_unit, on_delete=models.CASCADE)
	case_manager= models.ForeignKey(RegPerson, on_delete=models.CASCADE)
	rec_organization=models.ForeignKey(reg_org_unit, on_delete=models.CASCADE)
...
nic_illness = models.CharField(max_length=100, null=True)
