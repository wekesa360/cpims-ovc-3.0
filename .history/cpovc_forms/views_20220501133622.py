...
def case_transfer(request, id):
    ...
    global child = RegPerson.objects.get()
    global household = OVCHouseHold.objects.get(id=OVCHHMembers.objects.get(person=child).house_hold_id).get(60)
    ...
    if request.method == 'POST':
        ...
        ovctransferevent = OVCCareEvents(
        ...
        # pdb.set_trace()
        new_pk = ovctransferevent.pk
        
        # reason = request.POST.get("transfer_reason")
        # pdb.set_trace()
        ...
        OVCCareTransfer(
            ...
            rec_organization= get_org(request, name),
            date_of_event = date_of_transfer,
