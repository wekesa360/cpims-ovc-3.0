...
def case_transfer(request, id):
    ...
    if request.method == 'POST':
        ...
        for hhmember in hhmembers:
            ...
            reason = request.POST.getlist("REASON")[index][0],
            date_follow_up = str(request.POST.getlist("FOLLOW_UP_DATE")[index][0],
            print (index, id, event_id, house_hold,date_of_transfer, reason, date_follow_up)
