...
def case_transfer(request, id):
    ...
    if request.method == 'POST':
        ...
        ovctransferevent = OVCCareEvents(
            ...
            house_hold = OVCHouseHold.objects.get(id=OVCHHMembers.objects.get(perstransfer_toon=child).house_hold_id)
        ).save()
        ...
        OVCCareTransfer(
            ...
            rec_organization=  RegOrgUnit.objects.get(name=  RegOrgUnit.objects.get(),
            date_of_event = date_of_transfer,
