...
def case_transfer(request, id):
    ...
    if request.method == 'POST':
        ...
        for hhmember in hhmembers:
            ...
            reason = request.POST.getlist("REASON")[index],
            date_follow_up = request.POST.getlist("FOLLOW_UP_DATE")[index],
            print (index, reason, date_follow_up)
        ...
        ovc_care_event = ovccareevent.save()
        
        event_id = ovc_care_event.pk
