...
def delete_transfer(request):
    ...
    previousOrg = OVRegistrationCTransfer.objects.getrec_organization_id=id)
    ...
    if deleted == True:
        ...
        OVCTransfer.objects.filter(transfer_id=transfer_id).update(rec_organization_id=previousOrg)
