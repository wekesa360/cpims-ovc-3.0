    ...
    try:
        ...
        if request.method == 'POST':
            ...
            for hhmember in hhmembers:
                ...
                OVCRegistration.objects.filter(person_id=id).update_or_create(child_cbo=organization_id, is_void=True)
                RegPersonsOrgUnits.objects.filter(person_id=id).update_or_create(org_unit_id=organization_id, is_void=True)
