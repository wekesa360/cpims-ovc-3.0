...
def case_transfer(request, id):
    ...
    if request.method == 'POST':
        ...
        ovctransferevent = OVCCareEvents(
            ...
            house_hold = householdOVCHouseHold.objects.get(id=OVCHHMembers.objects.get(perstransfer_toon=child).house_hold_id)
        ).save()
        ...
        OVCCareTransfer(
            ...
            rec_organization=  RegOrgUnit.objects.get(id=id),
            date_of_event = date_of_transfer,
