...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='ovccaretransfer',
            name='organization',
            field=models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='current_orgranization', to='cpovc_registry.regorgunit'),
        ),
        migrations.AddField(
            model_name='ovccaretransfer',
            name='person',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receiving_organization', to='cpovc_registry.regorgunit'),
        ),
        migrations.AddField(
